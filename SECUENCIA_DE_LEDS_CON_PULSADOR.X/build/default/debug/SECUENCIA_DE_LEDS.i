# 1 "SECUENCIA_DE_LEDS.s"
# 1 "<built-in>" 1
# 1 "SECUENCIA_DE_LEDS.s" 2
...
;CONFIGURACION DE LOS FUSIBLES
    ...
    CONFIG LVP = OFF ;RESERVA DEL PIN ((PORTB) and 07Fh), 3 PARA PROGRAMACIÓN, DESACTIVADO
...
CONFIGURACION:
        ...
        BSF TRISD,0 ;EL BIT ((PORTC) and 07Fh), 0 SE CONFIGURA COMO ENTRADA
...
;---------ANTIRREBOTE------------
               BTFSS PORTD,0 ;TESTEAMOS SI EL BIT ((PORTB) and 07Fh), 0 ESTA EN 1 LOGICO, SI ESTA EN 1 LOGICO REALIZA UN SALTO
